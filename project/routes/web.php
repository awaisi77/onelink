...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/orders/withheld', 'Admin\OrderController@withheld')->name('admin-order-withheld');
...
//added by awais
      Route::get('/products/approval/datatables', 'Admin\ProductController@approvalDatatable')->name('admin-prod-approval-datatables'); //JSON REQUEST
      Route::get('/products/approval', 'Admin\ProductController@approval')->name('admin-prod-approval');

      Route::get('/products/approval/accept/{id}', 'Admin\ProductController@approveVendorProduct')->name('admin-prod-approval-accept');
      Route::post('/products/approval/deny/{id}', 'Admin\ProductController@denyVendorProduct')->name('admin-prod-approval-deny');
      Route::get('/products/approval/deny/{id}', 'Admin\ProductController@denyVendorProductModal')->name('admin-prod-approval-deny-modal');
  ...
  Route::get('/vendors/create', 'Admin\VendorController@createVendor')->name('admin-vendor-create');
  Route::post('/vendors/save', 'Admin\VendorController@submitVendor')->name('admin-vendor-save');
...
// Verification Section
  ...
  Route::get('/verificatons/declined', 'Admin\VerificationController@declined')->name('admin-vr-declined');
  Route::get('/verificatons/approved', 'Admin\VerificationController@approved')->name('admin-vr-approved');
...
Route::post('the/ActiveHouse/ocean/2441139', 'Front\FrontendController@subscription');
...
Route::prefix('vendor')->group(function() {
    Route::get('register', 'Vendor\RegisterController@showRegisterForm')->name('vendor-register');
    Route::get('business-register', 'Vendor\RegisterController@showBusinessForm')->name('vendor-business-register');
    Route::post('business-register-submit', 'Vendor\RegisterController@registerBusiness')->name('vendor-business-submit');
    Route::get('countries', 'Vendor\RegisterController@getCountries')->name('countries');
    Route::get('states', 'Vendor\RegisterController@getCountryState')->name('states');
    Route::get('cities', 'Vendor\RegisterController@getStateCities')->name('cities');
    Route::post('register', 'Vendor\RegisterController@register')->name('vendor-register-submit');
    Route::get('/register/verify/{token}', 'User\RegisterController@token')->name('user-register-token');
  ...
  Route::get('/dashboard', 'Vendor\VendorController@index')->name('vendor-dashboard');
          ...
          //IMPORT SECTION
          Route::get('/products/import/create', 'Vendor\ImportController@createImport')->name('vendor-import-create')->middleware('vendor-verify');
          ...
          Route::get('/products/import/index', 'Vendor\ImportController@index')->name('vendor-import-index')->middleware('vendor-verify');
          ...
          //------------ ADMIN ORDER SECTION ------------
          Route::get('/orders', 'Vendor\OrderController@index')->name('vendor-order-index')->middleware('vendor-verify');
          Route::get('/orders/{type}', 'Vendor\OrderController@indexType')->name('vendor-order-index-type')->middleware('vendor-verify');
          ...
          Route::get('/products', 'Vendor\ProductController@index')->name('vendor-prod-index')->middleware('vendor-verify');
          Route::get('/products/approved', 'Vendor\ProductController@approved')->name('vendor-prod-approved')->middleware('vendor-verify');
          Route::get('/products/pending', 'Vendor\ProductController@pending')->name('vendor-prod-pending')->middleware('vendor-verify');
          Route::get('/products/rejected', 'Vendor\ProductController@rejected')->name('vendor-prod-rejected')->middleware('vendor-verify');

          Route::post('/products/upload/update/{id}', 'Vendor\ProductController@uploadUpdate')->name('vendor-prod-upload-update');

          // CREATE SECTION
          Route::get('/products/types', 'Vendor\ProductController@types')->name('vendor-prod-types')->middleware('vendor-verify');
          Route::get('/products/physical/create', 'Vendor\ProductController@createPhysical')->name('vendor-prod-physical-create')->middleware('vendor-verify');
          ...
          Route::get('/products/import', 'Vendor\ProductController@import')->name('vendor-prod-import')->middleware('vendor-verify');;
          ...
          Route::get('/products/catalogs', 'Vendor\ProductController@catalogs')->name('admin-vendor-catalog-index')->middleware('vendor-verify');
          ...
          Route::get('/shipping', 'Vendor\ShippingController@index')->name('vendor-shipping-index')->middleware('vendor-verify');
          ...
          Route::get('/package', 'Vendor\PackageController@index')->name('vendor-package-index')->middleware('vendor-verify');
          ...
          Route::post('/profile/picture', 'Vendor\VendorController@profileupdate')->name('vendor-profile-picture');
          Route::post('business-register', 'Vendor\RegisterController@profileupdate')->name('vendor-profile-update');
          // Vendor Profile Ends
          ...
          // Vendor Shipping Cost
          Route::get('/banner', 'Vendor\VendorController@banner')->name('vendor-banner')->middleware('vendor-verify');

          // Vendor Social
          Route::get('/social', 'Vendor\VendorController@social')->name('vendor-social-index')->middleware('vendor-verify');
          ...
          Route::get('/withdraw', 'Vendor\WithdrawController@index')->name('vendor-wt-index')->middleware('vendor-verify');
          ...
          Route::get('/service', 'Vendor\ServiceController@index')->name('vendor-service-index')->middleware('vendor-verify');
