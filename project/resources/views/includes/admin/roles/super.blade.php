    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
		 <li>
                <a href="{{ route('admin-prod-approval') }}"><span>{{ __('Product Approval') }}</span></a>
            </li>
			  <li>
...
<li>
        ...
        <ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
            <li>
                <a href="{{route('admin-order-withheld')}}"> {{ __('Withheld Orders') }}</a>
            </li>
       	<li>
            ...
            <li>
                <a href="{{route('admin-order-declined')}}"> {{ __('Canceled Orders') }}</a>
            </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
            <li>
             ...
             <li>
                <a href="{{ route('admin-vendor-create') }}"><span>{{ __('Add Vendor') }}</span></a>
            </li>
            <li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor1" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-vr-approved') }}"><span>{{ __('Approved Verifications') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-vr-declined') }}"><span>{{ __('Declined Verifications') }}</span></a>
            </li>
        </ul>
    </li>
