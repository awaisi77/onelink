          ...
          <div class="xzoom-container">
            ...
            <div class="product-price">
              <p class="title">{{ $langg->lang87 }} :</p>
                  ...
                  <p class="p-sku">
                    {{ $langg->lang77 }}: <span class="idno text-capitalize">{{ $productt->sku }}</span>
                  </p>
                  @endif
                  <p class="p-sku">
                    {{ __("Part Number") }}: <span class="idno text-capitalize">{{ $productt->part_no }}</span>
                  </p>
                  <p class="p-sku">
                    {{ __("Make") }}: <span class="idno text-capitalize">{{ $productt->make }}</span>
                  </p>
                  <p class="p-sku">
                    {{ __("Origin") }}: <span class="idno text-capitalize">{{ $productt->origin }}</span>
                  </p>
      @if($gs->is_report)
