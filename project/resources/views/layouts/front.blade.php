                    ...
                    <div class="right-content">
                        <div class="list">
                            <ul>
                                ...
                                @else
                                    <li>
                                        <!--                                           data-toggle="modal" data-target="#vendor-login"-->
                                        <a href="{{route('vendor-register')}}"
                                           class="sell-btn">{{ __('Become a Vendor') }}</a>
                                    </li>
                                @endif
                                @endif
                        ...
                        <div class="categori-container" id="catSelectForm">
                            <select name="category" id="category_select" class="categoris">
                                ...
                                @foreach($categories as $data)
                                    <option
                                        value="{{ $data->slug }}" {{ Request::route('category') == $data->slug ? 'selected' : '' }}>{{ $data->name }}</option>
                                @endforeach
                            </select>
                        </div>
        ...
        <div class="row align-items-center mainmenu-area-innner">
            <div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding">
                ...
                <div class="categories_menu">
                    ...
                    <div class="categories_menu_inner" style="overflow: scroll;">
                        <ul>
                            @php
                                $i=1;
                            @endphp
            ...
            <div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
                <nav hidden>
                    ...
                    <ul class="menu">
                        ...
                        @endif
                        @foreach(DB::table('pages')->where('header','=',1)->orderBy('id','desc')->get() as $data)
                ...
                <div class="footer-widget recent-post-widget">
                    ...
                    <div class="footer-address">
                        <p>
                            ...
                            Head Office Address
                            Suit # 4, 1st Floor Liberty Heights,
                        ...
                        <p>
                            ...
                            Phone Number:
                            <a href="tel:+924235872667-9">+92 42 3587 2667-9</a>
                        </p>
                        <p>
                            Email Address:
                            <a href="mailto:info@1linkindustry.com">info@1linkindustry.com</a>
                        </p>
                    </div>
                </div>
            </div>
