...
<head>
    	...
    	<meta name="author" content="1LinkIndustry">
						...
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="order" data-parent="#accordion" >
                                    ...
                                    <li>
                                        <a href="{{route('vendor-order-index-type','pending')}}">{{__('Pending Orders')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{route('vendor-order-index-type','completed')}}">{{__('Completed Orders')}}</a>
                                    </li>
                                     <li>
                                        <a href="{{route('vendor-order-index-type','canceled')}}">{{__('Canceled Orders')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{route('vendor-order-index-type','processing')}}">{{__('Processing Orders')}}</a>
                                    </li>
                                    <li>
                                        <a href="{{route('vendor-order-index-type','withheld')}}">{{__('With-Held Orders')}}</a>
                                    </li>
                                    <li>
							...
							<li>
								...
								<ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
									...
									<li>
										<a href="{{ route('vendor-prod-approved') }}"><span>Approved</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-prod-pending') }}"><span>Pending</span></a>
									</li>
									<li>
										<a href="{{ route('vendor-prod-rejected') }}"><span>Rejected</span></a>
									</li>
<!--									<li>
...
<style>
	div#ActiveHousetable_processing {
