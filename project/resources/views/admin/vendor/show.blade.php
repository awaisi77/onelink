                                ...
                                <div class="col-md-4">
                                    <div class="user-image">
                                        @if($data->is_provider == 1)
                                            <img
                                                src="{{ $data->photo ? asset($data->photo):asset('assets/images/noimage.png')}}"
                                                alt="No Image">
                                        @else
                                            <img
                                                src="{{ $data->photo ? asset('assets/images/users/'.$data->photo):asset('assets/images/noimage.png')}}"
                                                alt="{{ __("No Image") }}">
                                        @endif
                                    ...
                                    <div class="table-responsive show-table">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ App\Models\Product::vendorConvertPrice(Auth::user()->current_balance) }}</td>
                                            </tr>
                                                    ...
                                                    @if($data->checkStatus())
                                                        ...
                                                        <a class="set-gallery1" href="javascript:;" data-toggle="modal"
                                                           data-target="#setgallery"><input type="hidden"
                                                                                            value="{{ $data->verifies()->where('status','=','Verified')->first()->id }}">(View)</a>
                                                    @else
                                        ...
                                        <div class="table-responsive show-table">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td>{{$data->vendorDetail->company_name}}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Country") }}</th>
                                                    <td>{{ $data->vendorDetail->shop_name }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("City") }}</th>
                                                    <td>{{ $data->vendorDetail->address_country }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("State") }}</th>
                                                    <td>{{ $data->vendorDetail->address_state }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Street Address") }}</th>
                                                    <td>{{ $data->vendorDetail->address_street }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Nature of Business") }}</th>
                                                    <td>{{ $data->vendorDetail->business_nature }}</td>
                                                </tr>

                                                <tr>
                                                    <th>{{ __("Industry of work") }}</th>
                                                    <td>{{ $data->vendorDetail->industry_of_work }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Company Email") }}</th>
                                                    <td>{{ $data->vendorDetail->company_email }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Company Phone/Fax") }}</th>
                                                    <td>{{ $data->vendorDetail->company_phone }}</td>
                                                </tr>
                                                <tr>
                                                    <th>{{ __("Country of Incorporation") }}</th>
                                                    <td>{{ $data->vendorDetail->country_of_incorporation }}</td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="action-list">
                                                            <select
                                                                ...
                                                                <option data-val="1"
                                                                        value="{{ route('admin-prod-status',['id1' => $data->id, 'id2' => 1]) }}" {{ $dt->status == 1 ? 'selected' : '' }}>{{ __("Activated") }}</option>
                                                                <
                                                                <option data-val="0"
                                                                        value="{{ route('admin-prod-status',['id1' => $data->id, 'id2' => 0]) }}" {{ $dt->status == 0 ? 'selected' : '' }}>{{ __("Deactivated") }}</option>
                                                            </select>
                                                        </div>
                                                    </td>
                                                    <td>
