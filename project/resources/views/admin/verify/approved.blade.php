            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin-vr-index') }}">{{ __("Approved Verifications") }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-sm-6 text-right">
                        <a id="verify-btn" href="javascript:;" class="btn btn-success f-btn"> <i
                                class="fas fa-check"></i> {{ __("Verify") }}</a>
                    </div>
                    <div class="col-sm-6">
                        <a id="decline-btn" href="javascript:;" class="btn btn-danger f-btn"> <i
                                class="fas fa-times"></i> {{ __("Decline") }}</a>
                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#ActiveHousetable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-vr-datatables','Verified') }}',
