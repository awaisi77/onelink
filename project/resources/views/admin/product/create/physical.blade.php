            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Add Product') }}</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area" id="modalEdit">
                            ...
                            <form id="ActiveHouseform" action="{{route('admin-prod-store')}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Part Number') }}" name="part_no" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Product Make') }}" name="make" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Product Origin') }}" name="origin" required="">
                                    </div>
                                </div>
                                ...
                                <div id="sub_cat_block" style="display: none;">
                                ...
                                <div id="child_sub_cat_block" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Feature Image') }} *
                                                <p class="sub-heading">{{ __('(Recommended image size 325x325)') }}</p>
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
