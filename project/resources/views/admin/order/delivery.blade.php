                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="ActiveHouseformdata" action="{{route('admin-order-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select name="status" required="">
                                ...
                                <option value="withheld" {{ $data->status == "withheld" ? "selected":"" }}>{{ __('With Held') }}</option>
                              </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea class="input-field"
                                      required
                                      name="track_text" placeholder="{{ __('Enter Track Note Here') }}"></textarea>
                          </div>
                        </div>
