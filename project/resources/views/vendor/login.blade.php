                            ...
                            <div class="login-area signup-area">
                                ...
                                <div class="login-form signup-form">
                                    ...
                                    <form
                                        ...
                                        <div class="form-input">
                                            <input type="date" class="User Name" name="dob"
                                                   min="1950-01-01" max="2021-12-30"
                                                   placeholder="{{ $langg->lang184 }}" required="">
                                        ...
                                        <div class="form-input">
                                            <select class="User Name"
                                                    style="border-radius:15px;width: 100%;height: 50px;background: #fff;padding: 0px 30px 0px 45px;border: 1px solid rgba(0, 0, 0, 0.1);font-size: 14px;"
