...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ $langg->lang629 }} <a class="add-btn"
                                                                 href="{{ route('vendor-dashboard') }}"><i
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('vendor-dashboard') }}">{{ $langg->lang445 }}</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area" id="modalEdit">
                            ...
                            <form id="ActiveHouseform" action="{{route('vendor-prod-store')}}" method="POST"
