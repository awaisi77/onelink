...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"> {{ $langg->lang704 }} <a class="add-btn"
                ...
                <div class="col-lg-12">
                    <div class="product-description">
                        <div class="body-area" id="modalEdit">
                            ...
                            <form id="ActiveHouseform" action="{{route('vendor-prod-update',$data->id)}}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Part#') }}* </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Part Number') }}" value="{{ $data->part_no }}"
                                               name="part_no" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Make') }}* </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Product Make') }}" value="{{ $data->make }}"
                                               name="make" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Origin') }}* </h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field"
                                               placeholder="{{ __('Enter Product Origin') }}"
                                               value="{{ $data->origin }}" name="origin" required="">
                                    </div>
                                </div>
                                ...
                                <div class="row link {{ $data->link != null ? '':'hidden' }}">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea class="input-field" rows="4" name="link"
                                                  placeholder="{{ $langg->lang696 }}" {{ $data->link != null ? 'required':'' }}>{{ $data->link }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="featured-keyword-area">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <input type="text" name="license[]" class="input-field"
                                                                       placeholder="{{ $langg->lang698 }}" required="">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <input type="number" min="1" name="license_qty[]"
                                                                       class="input-field"
                                            ...
                                            <a href="javascript:;" id="license-btn" class="add-fild-btn"><i
                                                        class="icofont-plus"></i> {{ $langg->lang700 }}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input name="youtube" type="text" class="input-field"
                                               placeholder="{{ $langg->lang682 }}" value="{{$data->youtube}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" placeholder="{{ $langg->lang703 }}e"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 text-center">
                                        <button class="addProductSubmit-btn"
                                                type="submit">{{ $langg->lang706 }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
