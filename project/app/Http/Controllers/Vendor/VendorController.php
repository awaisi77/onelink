...
class VendorController extends Controller
{
    ...
    public function __construct()
    {
      ...
      //  $this->middleware('vendor-verify')->except(['except' => 'index','verify','verifysubmit','warningVerify']);
    ...
    {
        $data = Auth::user();
        $vendorDetail = $data->vendorDetail;

        if (!empty($vendorDetail)) {
            $contact = Contact::where('vendor_details_id', $vendorDetail->id)->first();
        }else
            $contact=null;
        return view('vendor.profile',compact('data','vendorDetail','contact'));
    }
