...
class VerificationController extends Controller
{
    ...
    public function datatables($status)
    {
        if ($status == 'Pending') {
            ...
            $datas = Verification::where('status', '=', 'Verified')->get();
        } else if ($status == 'Declined') {
            $datas = Verification::where('status', '=', 'Declined')->get();
        } else {
    ...
    {
        return view('admin.verify.approved');
    }
    public function declined()
    {
        return view('admin.verify.declined');
    }
